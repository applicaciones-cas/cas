 ...
 * @author Unclejo
 */
public class Inv_Request_MC_Approval implements RequestApprovalController {
...
// Create a backup list to store deleted records temporarily
    ...
    public Inv_Request_MC_Approval(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
...
//                    if (poJSON != null) {
    ...
    public JSONObject searchTransaction(String fsColumn, String fsValue, boolean fbByCode) {
        ...
        String lsSQL = MiscUtil.addCondition(getSQL(), " a.sTransNox LIKE "
                + SQLUtil.toSQL(fsValue + "%") + " AND LEFT(a.sTransNox, 4) = " + SQLUtil.toSQL(poGRider.getBranchCode()) + " AND " + lsCondition + " AND f.sCategCd1 = '0001' AND f.sCategCd2 = '0007' GROUP BY a.sTransNox ASC");
...
//use for testing 
        ...
        try {
            ...
            Logger.getLogger(Inv_Request_MC_Approval.class.getName()).log(Level.SEVERE, null, ex);
        }
