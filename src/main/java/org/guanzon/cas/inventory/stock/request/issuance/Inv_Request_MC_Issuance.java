 ...
 * @author Unclejo
 */
public class Inv_Request_MC_Issuance implements RequestIssuanceController {
    ...
    public Inv_Request_MC_Issuance(GRider foGRider, boolean fbWthParent) {
        poGRider = foGRider;
...
//                    if (poJSON != null) {
    ...
    public JSONObject searchTransaction(String fsColumn, String fsValue, boolean fbByCode) {
        ...
        try {
            ...
            Logger.getLogger(Inv_Request_MC_Issuance.class.getName()).log(Level.SEVERE, null, ex);
        }
