                    ...
                    switch (Status) {
                        case "0":
                            if (ShowMessageFX.YesNo(null, pxeModuleName, "Do you want to Activate this Parameter?") == true) {
                                poJsON = oParameters.Region().postTransaction();
                        ...
                        case "1":
                            if (ShowMessageFX.YesNo(null, pxeModuleName, "Do you want to Deactivate this Parameter?") == true) {
                                poJsON = oParameters.Region().voidTransaction();
                                ShowMessageFX.Information((String) poJsON.get("message"), "Computerized Accounting System", pxeModuleName);
                                loadRecord();
                            }
                            break;
            ...
            try {
                switch (lnIndex) {
                    ...
                    case 6:
                        ...
                        if (lnIndex == 3) {
                            oParameters.Region().getModel().setMinimumWage(amount);
                        }
                        if (lnIndex == 4) {
                            oParameters.Region().getModel().setCOLAmount(amount);
                        }
                        if (lnIndex == 5) {
                            oParameters.Region().getModel().setMinimumWage2(amount);
                        }
                        if (lnIndex == 6) {
