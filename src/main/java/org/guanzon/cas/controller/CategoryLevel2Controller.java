        ...
        if (source instanceof Button) {
            ...
            switch (clickedButton.getId()) {
                ...
                case "btnNew":
                    ...
                    JSONObject poJSON = oParameters.CategoryLevel2().newRecord();
                ...
                case "btnBrowse":
                    ...
                    break;
                case "btnUpdate":
                    poJSON = oParameters.CategoryLevel2().updateRecord();
                    if ("error".equals((String) poJSON.get("result"))) {
                        ShowMessageFX.Information((String) poJSON.get("message"), "Computerized Acounting System", pxeModuleName);
                        break;
                    }
                ...
                case "btnCancel":
                    ...
                    break;
                case "btnSave":
                    oParameters.CategoryLevel2().getModel().setModifyingId(oApp.getUserID());
                    oParameters.CategoryLevel2().getModel().setModifiedDate(oApp.getServerDate());
                    JSONObject saveResult = oParameters.CategoryLevel2().saveRecord();
                    ...
                    switch (Status) {
                        case "0":
                            if (ShowMessageFX.YesNo(null, pxeModuleName, "Do you want to Activate this Parameter?") == true) {
                                poJsON = oParameters.CategoryLevel2().postTransaction();
                        ...
                        case "1":
                            if (ShowMessageFX.YesNo(null, pxeModuleName, "Do you want to Deactivate this Parameter?") == true) {
                                poJsON = oParameters.CategoryLevel2().voidTransaction();
                                ShowMessageFX.Information((String) poJsON.get("message"), "Computerized Accounting System", pxeModuleName);
                                loadRecord();
                            }
                            break;
    ...
    final ChangeListener<? super Boolean> txtField_Focus = (o, ov, nv) -> {
        ...
        if (!nv) {
            try {
                switch (lnIndex) {
                    case 1:
                        oParameters.CategoryLevel2().getModel().setCategoryId(lsValue);
                        break;
                    case 2:
                        oParameters.CategoryLevel2().getModel().setDescription(lsValue);
                        break;
//                    case 3:
//                        oParameters.CategoryLevel2().getModel().setDescription(lsValue);
//                        break;
...
//                        break;
    ...
    private void loadRecord() {
        boolean lbActive = oParameters.CategoryLevel2().getModel().getRecordStatus() == "1";

        txtField01.setText(oParameters.CategoryLevel2().getModel().getCategoryId());
        txtField02.setText(oParameters.CategoryLevel2().getModel().getDescription());
        txtField03.setText(oParameters.CategoryLevel2().getModel().InvType().getDescription());
        txtField04.setText(oParameters.CategoryLevel2().getModel().Category().getDescription());

        switch (oParameters.CategoryLevel2().getModel().getRecordStatus()) {
            case "1":
    ...
    void cbField01_Clicked(MouseEvent event) {
        if (cbField01.isSelected()) {
            oParameters.CategoryLevel2().getModel().setRecordStatus("1");
        } else {
            oParameters.CategoryLevel2().getModel().setRecordStatus("0");
        }
    }
