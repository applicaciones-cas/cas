 ...
 * @author User
 */
public class InvRequestCancellationGIController implements Initializable, ScreenInterface {
                ...
                case 12:/*QTY Request*/
                    if (lsValue.matches("\\d*")) {
                        ...
                        if("error".equals((String) jsonObject.get("result"))){
                            ShowMessageFX.Information((String) jsonObject.get("message"), "Computerized Accounting System", pxeModuleName);
                        }
                        loadItemData();
                        break;
                    } else {
...
//        params.put("sTranQty", "Cancel");
        ...
        String sourceFileName = "D://GGC_Maven_Systems/Reports/InventoryRequestGICancellation.jasper";
