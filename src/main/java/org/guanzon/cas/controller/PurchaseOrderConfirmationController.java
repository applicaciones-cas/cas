...
//                String.valueOf(loMdl.getModel().getYearModel());
    ...
    public void initDetailsGrid2() {
        ...
        index12.setCellValueFactory(new PropertyValueFactory<ModelPurchaseOrder, String>("index11"));
        index13.setCellValueFactory(new PropertyValueFactory<ModelPurchaseOrder, String>("index12"));
