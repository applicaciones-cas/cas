...
// Define arrays for text fields with setOnKeyPressed handlers
        TextField[] keyPressedTextFields = {
            txtField05, txtField08, txtField09, txtField11, txtField06
        };
...
// Set the value of the DatePicker to the parsed LocalDate
    ...
    private void loadDetails() {
        if (!oTrans.getDetailModel().isEmpty()) {
            ...
            txtField12.setText("");
            txtField13.setText("");
            txtField14.setText(String.valueOf(oTrans.getDetailModel().get(pnRow).getMinimumLevel()));
            txtField15.setText(String.valueOf(oTrans.getDetailModel().get(pnRow).getMaximumLevel()));
            txtField16.setText(String.valueOf(oTrans.getDetailModel().get(pnRow).getQuantityOnHand()));
            txtField17.setText((String) oTrans.getDetailModel().get(pnRow).getClassify());   
            txtField19.setText(String.valueOf(oTrans.getDetailModel().get(pnRow).getReservedOrder()));
            txtField20.setText(String.valueOf(oTrans.getDetailModel().get(pnRow).getBackOrder()));
        }
    }
