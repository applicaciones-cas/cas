 ...
 * @author User
 */
public class InventoryRequestMotorcycleROQController implements Initializable, ScreenInterface {
...
//        RequestControllerFactory.RequestType types = RequestControllerFactory.RequestType.MC;;
