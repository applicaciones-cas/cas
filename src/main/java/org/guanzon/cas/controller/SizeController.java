...
//                                poJsON = oParameters.Size().postTransaction();
...
//                                poJsON = oParameters.Size().voidTransaction();
//                                ShowMessageFX.Information((String) poJsON.get("message"), "Computerized Accounting System", pxeModuleName);
//                                loadRecord();
//                            }
//                            break;
...
////                            ShowMessageFX.Information((String) poJson.get("message"), "Computerized Acounting System", pxeModuleName);
////                        }
////                        oParameters.Size().getModel().setMeasureId(oParameters.Brand().getModel().getBrandId());
...
////                            ShowMessageFX.Information((String) poJson.get("message"), "Computerized Acounting System", pxeModuleName);
////                        }
////                        oParameters.Size().getModel().setSeriesId( oParameters.ModelSeries().getModel().getSeriesID());
...
//                switch (lnIndex) {
//                    case 1:
//                        oParameters.Size().getModel().setSectionId(lsValue);
//                        break;
//                    case 2:
//                        oParameters.Size().getModel().setSectionName(lsValue);
//                        break;
//                    default:
//                        break;
//                }
...
//
//        txtField01.setText(oParameters.Size().getModel().getSectionId());
//        txtField02.setText(oParameters.Size().getModel().getSectionName());
//        
