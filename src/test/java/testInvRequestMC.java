...
public class testInvRequestMC {
    ...
    public static void setUpClass() {
        ...
        record.setType(RequestControllerFactory.RequestType.MC);
...
//        
        ...
        loJSON = record.searchDetail(0, 3, "AL115C-40C6", true);
        if ("error".equals((String) loJSON.get("result"))) {
            Assert.fail((String) loJSON.get("message"));
        }
        ...
        Assert.assertEquals("M00124000019", record.getDetailModel().get(record.getDetailModel().size()-1).getStockID());
        ...
        Assert.assertEquals("AL115C-40C6", record.getDetailModel().get(record.getDetailModel().size()-1).getBarcode());
        Assert.assertEquals("MIO SPORTY 40C6", record.getDetailModel().get(record.getDetailModel().size()-1).getDescription());
        Assert.assertEquals("Motorcycle", record.getDetailModel().get(record.getDetailModel().size()-1).getCategoryName());
        Assert.assertEquals("Scooter", record.getDetailModel().get(record.getDetailModel().size()-1).getCategoryName2());
        ...
        loJSON = record.searchDetail(1, 3, "16163-0837", true);
        if ("error".equals((String) loJSON.get("result"))) {
            Assert.fail((String) loJSON.get("message"));
        }
        ...
        Assert.assertEquals("M00124000030", record.getDetailModel().get(record.getDetailModel().size()-1).getStockID());
        Assert.assertEquals("F", record.getDetailModel().get(record.getDetailModel().size()-1).getClassify());
        Assert.assertEquals(0, record.getDetailModel().get(record.getDetailModel().size()-1).getQuantityOnHand());
        Assert.assertEquals(0, record.getDetailModel().get(record.getDetailModel().size()-1).getReservedOrder());
        Assert.assertEquals(0, record.getDetailModel().get(record.getDetailModel().size()-1).getBackOrder());
        Assert.assertEquals(0, record.getDetailModel().get(record.getDetailModel().size()-1).getAverageMonthlySalary());
        Assert.assertEquals(0, record.getDetailModel().get(record.getDetailModel().size()-1).getMaximumLevel());
        Assert.assertEquals("16163-0837", record.getDetailModel().get(record.getDetailModel().size()-1).getBarcode());
        Assert.assertEquals("THROTTLE-ASSY", record.getDetailModel().get(record.getDetailModel().size()-1).getDescription());
        Assert.assertEquals("Motorcycle", record.getDetailModel().get(record.getDetailModel().size()-1).getCategoryName());
        Assert.assertEquals("Scooter", record.getDetailModel().get(record.getDetailModel().size()-1).getCategoryName2());
        Assert.assertEquals("Finished Products", record.getDetailModel().get(record.getDetailModel().size()-1).getCategoryType());
            ...
            for(int lnCtr = 0; lnCtr < record.getDetailModel().size(); lnCtr++){
                ...
                switch(lnCtr){
                    ...
                    case 2:
                        ...
                        Assert.assertEquals(55, record.getDetailModel().get(lnCtr).getQuantity());
