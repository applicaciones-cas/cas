...
//        
        ...
        Assert.assertEquals("M00124000002", record.getDetailModel().get(record.getDetailModel().size()-1).getStockID());
        Assert.assertEquals("F", record.getDetailModel().get(record.getDetailModel().size()-1).getClassify());
        Assert.assertEquals(43, record.getDetailModel().get(record.getDetailModel().size()-1).getQuantityOnHand());
        ...
        Assert.assertEquals("5TL-E4170-00-00", record.getDetailModel().get(record.getDetailModel().size()-1).getBarcode());
        Assert.assertEquals("DIAPHRAGM ASS'Y", record.getDetailModel().get(record.getDetailModel().size()-1).getDescription());
        ...
        loJSON = record.searchDetail(1, 3, "93210-07135-00", true);
        if ("error".equals((String) loJSON.get("result"))) {
            Assert.fail((String) loJSON.get("message"));
        }
        ...
        Assert.assertEquals("M00124000007", record.getDetailModel().get(record.getDetailModel().size()-1).getStockID());
        Assert.assertEquals("F", record.getDetailModel().get(record.getDetailModel().size()-1).getClassify());
        Assert.assertEquals(-5, record.getDetailModel().get(record.getDetailModel().size()-1).getQuantityOnHand());
        Assert.assertEquals(-3, record.getDetailModel().get(record.getDetailModel().size()-1).getReservedOrder());
        Assert.assertEquals(5, record.getDetailModel().get(record.getDetailModel().size()-1).getBackOrder());
        Assert.assertEquals(0, record.getDetailModel().get(record.getDetailModel().size()-1).getAverageMonthlySalary());
        Assert.assertEquals(0, record.getDetailModel().get(record.getDetailModel().size()-1).getMaximumLevel());
        Assert.assertEquals("93210-07135-00", record.getDetailModel().get(record.getDetailModel().size()-1).getBarcode());
        Assert.assertEquals("O-RING (583 OIL DRAIN BOLT)", record.getDetailModel().get(record.getDetailModel().size()-1).getDescription());
        Assert.assertEquals("Motorcycle", record.getDetailModel().get(record.getDetailModel().size()-1).getCategoryName());
        Assert.assertEquals("Spare Parts", record.getDetailModel().get(record.getDetailModel().size()-1).getCategoryName2());
        Assert.assertEquals("Finished Products", record.getDetailModel().get(record.getDetailModel().size()-1).getCategoryType());
    ...
    public void testOpenDetail() {
         JSONObject loJSON;
        loJSON = record.searchTransaction("sTransNox", "M00124000002", true);
        if ("error".equals((String) loJSON.get("result"))) {
            Assert.fail((String) loJSON.get("message"));
        }
        if(record.getDetailModel().size()>0){
            for(int lnCtr = 0; lnCtr < record.getDetailModel().size(); lnCtr++){
                ...
                Assert.assertEquals("M00124000002", record.getDetailModel().get(lnCtr).getTransactionNumber());
                switch(lnCtr){
                    case 0:
    ...
    public void testCloseTransaction() {
        ...
        loJSON = record.closeTransaction("M00124000002");
        if ("error".equals((String) loJSON.get("result"))) {
            Assert.fail((String) loJSON.get("message"));
        }
    ...
    public void testPostTransaction() {
        ...
        loJSON = record.postTransaction("M00124000002");
        if ("error".equals((String) loJSON.get("result"))) {
            Assert.fail((String) loJSON.get("message"));
        }
    ...
    public void testVoidTransaction() {
        ...
        loJSON = record.voidTransaction("M00124000002");
        if ("error".equals((String) loJSON.get("result"))) {
            Assert.fail((String) loJSON.get("message"));
        }
    ...
    public void testCancelTransaction() {
        ...
        loJSON = record.cancelTransaction("M00124000002");
        if ("error".equals((String) loJSON.get("result"))) {
            Assert.fail((String) loJSON.get("message"));
        }
